...
#define JOGADOR_ID 1  // Este é o Jogador 1

// Definição dos pinos dos botões
const int BOTAO_A = 18; // GPIO18
const int BOTAO_B = 4;  // GPIO4
const int BOTAO_C = 5;  // GPIO5
...
uint8_t masterMAC[] = {0xCC, 0x7B, 0x5C, 0x26, 0xBC, 0x90}; // Endereço MAC do Master
...
void setup() {
  ...
  Serial.println("Botões: GPIO18 (A), GPIO4 (B), GPIO5 (C)");
