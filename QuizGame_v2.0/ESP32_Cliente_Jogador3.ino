...
#define JOGADOR_ID 3  // Este é o Jogador 3

// Definição dos pinos dos botões
const int BOTAO_A = 12; // GPIO12
const int BOTAO_B = 13; // GPIO13
const int BOTAO_C = 14; // GPIO14
...
void setup() {
  ...
  Serial.println("Botões: GPIO12 (A), GPIO13 (B), GPIO14 (C)");
